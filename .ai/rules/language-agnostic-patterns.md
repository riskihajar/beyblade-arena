...
Then:
→ web_search("[package] latest stable version [current-month] [current-year]")
...
3. **Programming**: Fail fast, fix bug
...
/features
/auth - service - controller - repository
/products - service - controller - repository
