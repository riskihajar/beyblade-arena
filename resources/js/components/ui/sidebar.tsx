...
function SidebarMenuButton({
  ...
  const button = render ? (
    ...
    React.cloneElement(render as React.ReactElement<any>, {
      ...
      className: cn(sidebarMenuButtonVariants({ variant, size }), className, /* eslint-disable-next-line @typescript-eslint/no-explicit-any */
    (render as React.ReactElement<any>).props.className),
      ...props,
    })
  ) : (
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent
        side="right"
        // align="center" // Base UI tooltip aligns center by default or handled differently
