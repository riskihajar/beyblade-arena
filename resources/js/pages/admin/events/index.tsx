...
import { create, index as eventsIndex, show as showEvent } from '@/routes/admin/events';
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex flex-col gap-1">
                            <h1 className="text-2xl font-semibold tracking-tight">Manajemen Turnamen & Event</h1>
                            <p className="text-sm text-muted-foreground">
                                Kelola turnamen resmi Komunitas Beyblade Samarinda, divisi kategori, dan jadwal arena.
                            </p>
                        </div>
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            >
                                ...
                                <option value="registration_closed">Pendaftaran Tutup</option>
                        ...
                        {events.data.length === 0 ? (
                            <Empty className="py-12">
                                <EmptyHeader>
                                    ...
                                    <EmptyDescription>
                                        Mulai dengan membuat event turnamen baru untuk komunitas blader.
                                    </EmptyDescription>
                                </EmptyHeader>
                                <Button render={<Link href={create().url} />} className="mt-4">
                                    <Plus className="size-4" />
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        <TableHead>Nama Event & Musim</TableHead>
                                    ...
                                    {events.data.map((event) => (
                                        <TableRow key={event.id}>
                                            <TableCell className="font-medium">
                                                <Link
                                                    href={showEvent({ event: event.id }).url}
                                            ...
                                            <TableCell>
                                                <div className="flex items-center gap-1.5 text-sm">
                                                    ...
                                                    <span>{formatDate(event.event_start_at)}</span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                <div className="flex items-center gap-3 text-sm">
                                                    <span className="flex items-center gap-1">
                                                        ...
                                                        {event.categories_count ?? 0} Kategori
                                                    </span>
                                                    <span className="flex items-center gap-1">
                                                        <Users className="size-3.5 text-muted-foreground" />
                                                        {event.registrations_count ?? 0} Blader
                                                    </span>
                                                </div>
                                            </TableCell>
                                            <TableCell>
