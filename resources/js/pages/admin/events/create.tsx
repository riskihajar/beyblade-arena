                            ...
                            <Frame>
                                <FrameHeader>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <FrameTitle>Buat Event Turnamen</FrameTitle>
                                            <FrameDescription>
                                                Isi detail turnamen, lokasi venue Samarinda, dan jadwal pendaftaran.
                                            </FrameDescription>
                                        </div>
                                    </div>
                                </FrameHeader>
                                    ...
                                    <div className="space-y-6">
                                        <Fieldset className="space-y-4">
                                            ...
                                            <Field name="status" data-invalid={!!errors.status || undefined}>
                                                <FieldLabel htmlFor="status">Status Publikasi</FieldLabel>
                                                <select
                                                    id="status"
                                                    name="status"
                                                ...
                                                >
                                                    ...
                                                    <option value="published">Dipublikasikan (Pendaftaran belum buka)</option>
                                                    <option value="registration_open">Pendaftaran Dibuka Sekarang</option>
                                                </select>
