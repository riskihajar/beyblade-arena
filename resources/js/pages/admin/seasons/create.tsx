...
import { index as seasonsIndex, store } from '@/routes/admin/seasons';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Buat Musim', href: '#' },
];

export default function AdminSeasonsCreate() {
    const [isActive, setIsActive] = useState(true);

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat Musim Kompetisi Baru" />
