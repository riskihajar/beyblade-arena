...
import { type Event, type TournamentCategory, type TournamentRuleset } from '@/types/tournament';
...
export default function AdminCategoriesEdit({ category, event, rulesets }: Props) {
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'Dashboard', href: '/dashboard' },
        { title: 'Turnamen & Event', href: '/admin/events' },
        { title: event.name, href: showEvent({ event: event.id }).url },
        { title: `Edit Kategori: ${category.name}`, href: '#' },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-2xl px-4 py-8">
                <Form action={update({ category: category.id }).url} method="patch">
                    {({ processing, errors }) => (
                        <>
                            <Frame>
                                <FrameHeader>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <FrameTitle>Edit Kategori Divisi</FrameTitle>
                                            <FrameDescription>
                                        ...
                                        <Fieldset className="space-y-4">
                                            ...
                                            <Field name="ruleset_id" data-invalid={!!errors.ruleset_id || undefined}>
                                                ...
                                                <select
                                                    id="ruleset_id"
                                                    name="ruleset_id"
                                                    defaultValue={category.ruleset_id}
                                            ...
                                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                ...
                                                <Field name="target_points" data-invalid={!!errors.target_points || undefined}>
                                                    ...
                                                    <Input
                                                        ...
                                                        min="1"
                                                        max="20"
                                                        defaultValue={category.target_points}
                                                        required
                                                    />
                                            ...
                                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                                <Field name="max_participants" data-invalid={!!errors.max_participants || undefined}>
                                                    ...
                                                    <Input
                                                        ...
                                                        min="2"
                                                        max="512"
                                                        defaultValue={category.max_participants}
                                                        required
                                                    />
                                            ...
                                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                <Field name="deck_lock_policy" data-invalid={!!errors.deck_lock_policy || undefined}>
                                                    ...
                                                    <select
                                                        ...
                                                        defaultValue={category.deck_lock_policy}
                                                        className="h-9 w-full rounded-md border border-input bg-background px-3 text-sm shadow-xs focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                                                    >
                                                ...
                                                <Field name="call_timeout_seconds" data-invalid={!!errors.call_timeout_seconds || undefined}>
                                                    ...
                                                    <Input
                                                        ...
                                                        min="30"
                                                        max="600"
                                                        defaultValue={category.call_timeout_seconds}
                                                        required
                                                    />
