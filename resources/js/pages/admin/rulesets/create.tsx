...
import { index as rulesetsIndex, store } from '@/routes/admin/rulesets';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Buat Ruleset', href: '#' },
];

export default function AdminRulesetsCreate() {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Buat Ruleset Turnamen Baru" />
