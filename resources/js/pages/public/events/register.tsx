...
export default function PublicEventsRegister({ event, user }: Props) {
    ...
    const isJunior =
        ...
        (selectedCategory?.max_age !== undefined &&
            selectedCategory.max_age !== null &&
            selectedCategory.max_age <= 12);

    const updateDeckSlot = (
        index: number,
        field: keyof BeyCombo,
        value: string,
    ) => {
        setDeck((prev) => {
            const next = [...prev];
                ...
                <Card className="border-primary/20 bg-linear-to-br from-primary/5 via-card to-card shadow-sm">
                    <CardHeader className="pb-3">
                        ...
                        <CardDescription className="text-sm">
                            {event.description ||
                                'Pendaftaran resmi turnamen Beyblade X Komunitas Samarinda.'}
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="grid grid-cols-1 gap-3 pt-0 text-xs sm:grid-cols-2">
                        ...
                        <div className="space-y-6">
                                ...
                                <FramePanel className="space-y-4">
                                    <Fieldset className="space-y-4">
                                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                            ...
                                            >
                                                <FieldLabel htmlFor="display_nickname">
                                                    Nickname Panggilan di Bagan
                                                </FieldLabel>
                                                <Input
                                                    id="display_nickname"
                                                    name="display_nickname"
                                ...
                                <Frame className="border-amber-500/30 bg-amber-500/5">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-amber-700 dark:text-amber-300">
                                                    Wajib diisi untuk
                                                    pendampingan anak di bawah
                                                    13 tahun saat turnamen di
                                                    venue Samarinda. Data
                                                    terlindungi aman dan tidak
                                    ...
                                    <FramePanel className="space-y-4">
                                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                            ...
                                            >
                                                <FieldLabel htmlFor="guardian_phone">
                                                    No. HP / WhatsApp Wali
                                                </FieldLabel>
                                                <Input
                                                    id="guardian_phone"
                                            ...
                                            >
                                                <FieldLabel htmlFor="guardian_relationship">
                                                    Hubungan Keluarga
                                                </FieldLabel>
                                                <Input
                            ...
                            <Frame>
                                <FrameHeader>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            <FrameTitle>
                                                3. Deck Beyblade X (3 Combo
                                                Tanpa Part Duplikat)
                                            </FrameTitle>
                                            <p className="text-xs text-muted-foreground">
                                                Daftarkan combo 3 Beyblade Anda.
                                                Deck akan diverifikasi juri saat
                                                check-in di venue.
                                            </p>
                                        </div>
                                    </div>
                                            ...
                                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className="h-8 w-full rounded-md border border-input bg-background px-2.5 text-xs shadow-xs focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none"
                            ...
                            <Frame>
                                <FrameHeader>
                                    <div className="flex items-center gap-2">
                                        ...
                                        <FrameTitle>
                                            4. Persetujuan & Komitmen Turnamen
                                        </FrameTitle>
                                    </div>
                                </FrameHeader>
                                <FramePanel className="space-y-3">
                                    <div className="flex items-start space-x-2">
                                        ...
                                        <label
                                            htmlFor="agree_rules"
                                            className="cursor-pointer text-xs leading-normal font-medium"
                                        >
                                            Saya menyetujui seluruh Peraturan
                                            Resmi Turnamen Komunitas Beyblade
                                            Samarinda dan menghormati keputusan
                                            mutlak Juri/Wasit.
                                        </label>
                                    </div>
                                    ...
                                    <div className="flex items-start space-x-2">
                                        ...
                                        <label
                                            ...
                                            className="cursor-pointer text-xs leading-normal font-medium"
                                        >
                                            Saya mengizinkan dokumentasi foto
                                            dan video pertandingan untuk
                                            dipublikasikan pada media resmi
                                            komunitas.
                                        </label>
                                    </div>
                                    <FieldError
                                        error={errors.agree_media_release}
                                    />
                                </FramePanel>
                            </Frame>
                            ...
                            <div className="pt-2">
                                <Button
                                    ...
                                    disabled={
                                        processing || !agreeRules || !agreeMedia
                                    }
                                >
                                    {processing
                                        ? 'Memproses Pendaftaran...'
                                        : 'Kirim Pendaftaran Turnamen'}
                                </Button>
                                <p className="mt-2 text-center text-xs text-muted-foreground">
                                    Setelah submit, Anda akan mendapatkan nomor
