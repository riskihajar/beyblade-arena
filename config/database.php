    ...
    */
    ...
    'connections' => [
        ...
        'testing' => [
            ...
            'sslmode' => env('TEST_DB_SSLMODE', 'prefer'),
            'encrypt' => env('TEST_DB_ENCRYPT', 'yes'),
            'trust_server_certificate' => env('TEST_DB_TRUST_SERVER_CERTIFICATE', 'false'),
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                (PHP_VERSION_ID >= 80500 ? Mysql::ATTR_SSL_CA : PDO::MYSQL_ATTR_SSL_CA) => env('TEST_MYSQL_ATTR_SSL_CA'),
            ]) : [],
        ],
